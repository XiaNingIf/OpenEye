...
import com.jit.openeye.extension.logV
import com.jit.openeye.extension.screenPixel
import com.jit.openeye.ui.common.callback.GsonTypeAdapterFactory
    ...
    class BasicParamsInterceptor : Interceptor {
        override fun intercept(chain: Interceptor.Chain): Response {
            ...
            val url = originalHttpUrl.newBuilder().apply {
                ...
                addQueryParameter("vc", GlobalUtil.openEyeVersionCode.toString())
                addQueryParameter("vn", GlobalUtil.openEyeVersionName)
